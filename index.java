   ...
   JTextField tf1 = new JTextField();
    ...
    JButton b1 = new JButton("submit your vote");
     ...
     Font fs1 = new Font("ARIAL", Font.PLAIN, 30);
      Font fs = new Font("LUTO", Font.PLAIN, 20);
       Font fs2 = new Font("FUTURA", Font.PLAIN, 20);

       p.add(l3,BorderLayout.CENTER);
       p.setLayout(null);
       l1.setBounds(60 , 0, 400, 50);
       l2.setBounds(0 , 40, 220, 50);
       l3.setBounds(0 , 90, 220, 100);
       tf1.setBounds(210,50 ,300 ,30);
        ...
        new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e){
              ...
              {
                int i = JOptionPane.showMessageDialog(new JFrame(),"Do you want to confirm your vote ?");
